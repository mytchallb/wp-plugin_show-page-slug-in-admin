...
Contributors: Mytchall Bransgrove
Tags: page slug, admin column, permalink, admin interface
...
1. View of the Pages screen showing the slug under the new Permalink column.
...
= 1.0 =
* Initial Release. Enjoy the simple management of your page slugs directly in the admin interface!
